...
export const switchValueSelector = createSelector(
  mainSelector,
  (main: MainState) => main.switchValue,
)
export const selectedRadioSelector = createSelector(
  mainSelector,
  (main: MainState) => main.selectedRadio,
)
